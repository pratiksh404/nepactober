...
<section class="banner-section">
    <div class="container">
        <div class="banner-content">
            ...
            <div class="text">
                <h1 class="banner-title">Hidden gem<br> between Hatta Mountains</h1>
            </div>
        </div>
    </div>
</section>
...
<section class="banner-checking check-avail-form">
    <div class="wrapper box-shadow-2  border p-3">
        <div class="row align-items-center">
            <div class="col-md-8 col-12">
                <form action="#" class="filter-form d-flex align-items-center bg-white justify-content-center justify-content-lg-end pl-1">
                    <h2 class="xs-title text-center">Check - In</h2>
                    <span class="sep inlnie-block"></span>
                    <label>
                        <input type="text" class="no-guests sub-title date-pick">
                    </label>
                    <div class="book-btn ml-4">
                        <button type="submit" class="button-four-pri">
                            <span class="btn-title"></i>Check Availability </span>
                        </button>
                    </div>
                </form>
            </div>
            <div class="col-md-4 col-12">
                <h2 class="xs-title text-uppercase text-form">BEST RATE GURANTEED</h2>
            </div>
        </div>
    </div>
</section>
...
<section class="show-case-section">
    ...
    <header class="section-header">
        <div class="container">
            <div class="title-wrap">
                <h2 class="section-pre-title text-uppercase">Experience</h2>
                <h3 class="section-title">Impeccable <br> Avant-garde</h3>
            </div>
            <div class="section-content">
                <p>Surrounded by some of the most iconic views of Hatta, the villa is an expression of the city's natural vibrancy and its modern soul.</p>
            </div>
        </div>
    </header>
                    ...
                    <li class="glide__slide">
                        <div class="slide one">
                            <div class="slider-image">
                                <img src="assets/images/index/img-1.jpeg" />
                            </div>
                        </div>
                    </li>
                    <li class="glide__slide">
                        <div class="slide two">
                            <div class="slider-image">
                                <img src="assets/images/index/img-2.jpeg" />
                            </div>
                        </div>
                    </li>
                    <li class="glide__slide">
                        <div class="slide three">
                            <div class="slider-image">
                                <img src="assets/images/index/img-3.jpeg" />
                            </div>
                        </div>
                    </li>
                    <li class="glide__slide">
                        <div class="slide four">
                            <div class="slider-image">
                                <img src="assets/images/index/img-4.jpeg" />
                            </div>
                        </div>
                    </li>
                </ul>
    ...
    <!-- <div class="show-wrap">
        <div class="container-fluid">
            <div class="show-slider owl-carousel">
                <div class="slider-item">
                    <img src="assets/images/index/img-1.jpeg" alt="">
                </div>
                <div class="slider-item">
                    <img src="assets/images/index/img-2.jpeg" alt="">
                </div>
                <div class="slider-item">
                    <img src="assets/images/index/img-3.jpeg" alt="">
                </div>
                <div class="slider-item">
                    <img src="assets/images/index/img-4.jpeg" alt="">
                </div>
                <div class="slider-item">
                    <img src="assets/images/index/img-5.jpeg" alt="">
                </div>
                <div class="slider-item">
                    <img src="assets/images/index/img-6.jpeg" alt="">
                </div>
            </div>
        </div>
    </div> -->
...
<section class="cta-section">
    <img src="assets/images/index/img-10.png" alt="">
</section>
<!-- end of cta -->
<!-- Show Case SEction -->
<section class="show-case-section show-two-section">
    <!-- Header -->
    <header class="section-header">
        <div class="container">
            <div class="title-wrap">
                <h2 class="section-pre-title text-uppercase">Rooms & views</h2>
                <h3 class="section-title">Rooms <br> with a view</h3>
            </div>
            <div class="section-content two d-flex">
                <p>Surrounded by some of the most iconic views of Hatta, the villa is an expression of the city's natural vibrancy and its modern soul.</p>
                <p>Surrounded by some of the most iconic views of Hatta, the villa is an expression of the city's natural vibrancy and its modern soul.</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xl-7 col-lg-9 col-md-12">
                <div class="img-wrapper">
                    <img src="assets/images/index/img-1.jpeg" alt="">
                    <div class="content">
                        <h2 class="title">Infinity <br> swimming pool</h2>
                        <p>infinity swimming pool with enteral heater and cooletr</p>
                        <div class="btn-book">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-7 col-lg-9 col-md-12">
                <div class="img-wrapper">
                    <div class="content">
                        <h2 class="title">BBQ <br> & Grill</h2>
                        <p>We have the right experience for each guest, paying the utmost attention to every detail tto ensure that each stay is truly unique.</p>
                        <div class="btn-book">
                            <a href="#" class="btn-link">
                                <span class="arrow"><i class="fas fa-caret-right"></i></span>
                                Book Now
                    ...
                    <img src="assets/images/index/img-8.jpeg" alt="">
                </div>
            </div>
        </div>
    </div>
...
<section class="feature-section">
    <div class="container">
        <div class="row">
            <div class="col-xl-7 col-lg-9 col-md-12">
                <div class="img-wrapper">
                    <img src="assets/images/index/img-11.png" alt="">
                    <div class="content">
                        <h2 class="title">A Fully <br> Equipped Kitchen</h2>
                        <p>Suspended over Hatta and the Grand Mountains, our terraces completely immerse visitors in one of the most beautiful works of art in the world.</p>
                        <div class="btn-book">
                            <a href="#" class="btn-link">
                                <span class="arrow"><i class="fas fa-caret-right"></i></span>
                                Book Now
...
<section class="feature-section right">
    <div class="container">
        <div class="row">
            <div class="col-xl-7 col-lg-9 col-md-12">
                <div class="img-wrapper">
                    <img src="assets/images/index/img-12.png" alt="">
                    <div class="content">
                        <h2 class="title">Full <br> Entertainment</h2>
                        <p>We have subscribed all the major OTT platform for you and your family entertainment.</p>
                        <div class="btn-book">
                            <a href="#" class="btn-link">
                                <span class="arrow"><i class="fas fa-caret-right"></i></span>
                                Book Now
